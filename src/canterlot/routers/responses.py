...
CREATE_INVITE_RESPONSES: ResponseDict = {
    ...
    **RESP_401_AUTH,
    ...
    status.HTTP_409_CONFLICT: {
        "model": ErrorResponseModel,
        "description": "InviteEmailAlreadyRegisteredError: Target email already belongs to a registered account.",
        "content": error_example(InviteEmailAlreadyRegisteredError),
    },
