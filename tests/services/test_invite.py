...
def describe_get_preview_metadata():
    async def it_raises_for_an_unknown_invite(
        ...
        service = InviteService(invite_repo, club_repo, club_membership_repo, user_repo)

        with pytest.raises(InvalidInviteTokenError):
            await service.get_preview_metadata("bad-id")

    async def it_raises_for_a_deactivated_invite(
        invite_repo: AsyncMock,
        club_repo: AsyncMock,
        club_membership_repo: AsyncMock,
        user_repo: AsyncMock,
    ...
    async def it_raises_for_an_expired_invite(
        invite_repo: AsyncMock,
        club_repo: AsyncMock,
        club_membership_repo: AsyncMock,
        user_repo: AsyncMock,
...
def describe_rotate_public_link():
    ...
    async def it_deactivates_existing_links_and_issues_a_new_one(
        ...
        club_membership_repo.find_member_role_by_club_id_and_user_id.return_value = role
...
def describe_get_public_link():
    async def it_returns_the_active_public_link_id(
        invite_repo: AsyncMock,
        club_repo: AsyncMock,
        club_membership_repo: AsyncMock,
        user_repo: AsyncMock,
...
def describe_register_invite_usage():
    async def it_does_nothing_for_an_unknown_invite(
        invite_repo: AsyncMock,
        club_repo: AsyncMock,
        club_membership_repo: AsyncMock,
        user_repo: AsyncMock,
    ...
    async def it_burns_a_direct_invite_after_use(
        invite_repo: AsyncMock,
        club_repo: AsyncMock,
        club_membership_repo: AsyncMock,
        user_repo: AsyncMock,
